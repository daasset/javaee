    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                %>
                <li class="nav-item">
                    <a class="nav-link active" href="/my-page">My page</a>
                </li>
                <li class="nav-item">
...
<div class="container mt-5">
    <h5 class="mb-5 text-center">YOU CAN CHANGE YOUR NAME AND SURNAME</h5>

    <form action="/my-page" method="post" class="w-50 mx-auto">
        <!-- NAME -->
        <div class="mb-3 row ">
        ...
        <!-- SURNAME -->
        <div class="mb-3 row ">
            <label for="user-surname" class="col-sm-3 col-form-label">SURNAME:</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="user-surname" name="user-surname"
                       value="<%=currentUser.getSurname()%>">
            </div>
        </div>
