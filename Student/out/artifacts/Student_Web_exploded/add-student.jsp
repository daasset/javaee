...
<div class="container mt-5">
    <form action = "/add-student" method="post" class="w-50 mx-auto">
        <!-- Name -->
        <div class="mb-3 row ">
            <label for="student-name" class="col-sm-3 col-form-label">NAME:</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="student-name" name="student-name" placeholder="Insert your name">
            </div>
        </div>
        ...
        <div class="mb-3 row ">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="student-surname" name="student-surname" placeholder="Insert your surname">
            </div>
        </div>
        ...
        <div class="mb-3 row ">
            ...
            <div class="col-sm-9">
                <input type="date" class="form-control" id="student-birthdate" name="student-birthdate" placeholder="Choose your birthdate">
            </div>
        </div>
        ...
        <div class="mb-3 text-end">
            <button class="btn bg-success text-white">ADD STUDENT</button>
        </div>
    </form>
</div>
